...
// 6.) Max. Create method max() to return list’s largest val.
// 7.) Min. Create min() to return list’s smallest val.
// 8.) Average. Create average() to return average val.
...
console.log(myLinkedList.max());
console.log(myLinkedList.average());

// This is how you'd do Min Max Average all in one method:
class SLL {
    constructor() {
        this.head = null;
    }
